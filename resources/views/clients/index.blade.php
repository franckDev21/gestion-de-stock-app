  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-4">
    <div class="flex items-center justify-start  mt-6">
        ...
        <a
            ...
            <i class="fa-solid fa-user-plus mr-3"></i> Ajouter un nouveau client
        </a>
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            <td class="py-3 px-6 text-left whitespace-nowrap">
                                <div class="flex items-start flex-col justify-start">
                                    ...
                                    @else
                                        <span class="text-orange-500">Aucune addresse email</span>
                                    @endif
                                </div>
                            </td>
                            ...
                            <td class="py-3 px-6 text-left">
                                @if ($user->tel)
                                    <span>{{ $user->tel }}</span>
                                @else
                                    <span class="text-orange-500">Aucun numéro de téléphone</span>
                                @endif
                            </td>
                            ...
                            <td class="py-3 px-6 text-left">
                                <div class="flex item-center justify-center">
                                    ...
                                    <a href="{{ route('clients.edit',$user->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
