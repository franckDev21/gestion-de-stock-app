...
<body>
    ...
    <h3 style='text-decoration:underline; text-transform:uppercase;' class='text-center'>
        @if ($name === 'all')
            Historiques des entrées / sorties produits |
        @else
            @if ($name === 'sortie')
                Historiques des sorties produits |
            @else
                Historiques des entrées produits |
            @endif
        @endif
    ...
    <table class="min-w-max w-full table-auto" style="width: 100%">
        <thead>
            <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                <th class="py-3 px-4 text-left" style="width:150px;">Nom du produit</th>
                <th class="py-3 px-4 text-left" style="width:130px;">Date & Heure</th>
        ...
        <tbody class="text-gray-600 text-sm font-light">
            @foreach ($historiques as $history)
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-1 px-4 text-left"> <span
                            class=" py-1 rounded-full font-semibold">{{ $history->user->firstname }}
