...
<body class="facture">
    ...
    <x-facture-header :declare="$clientDeclare ?? false" />
    ...
    <div class="card">
        <div class="line">
            <span class="center"><span class="bold"> {{ $commande->client->firstname }} {{ $commande->client->lastname }}</span></span>
        </div>
    
        <div class="line">
            <span>Email : <span class=""> {{ $commande->client->email }} </span></span>
        </div>
    
        <div class="line">
            <span>Tél : <span class=""> {{ $commande->client->tel }} </span></span>
        </div>
    </div>
    ...
    <span class="bold">FACTURE N&deg;{{ $commande->facture->id }}/{{ date('m/Y') }}/solumat</span>
    <table>
        <thead>
        ...
        <tbody>
            @foreach ($commandes as $commande)
                <tr>
                    <td class="">{{ ucfirst($commande->product->nom) }}</td>
                    <td>{{ $commande->qte }}</td>
