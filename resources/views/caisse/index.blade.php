<x-app-layout>
  ...
  <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 pb-4 mt-5">
    <span class="py-4 mb-2 px-8 border-slate-200 border-8 rounded text-5xl font-bold text-gray-500 bg-slate-50 inline-block">
      <i class="fa-solid fa-sack-dollar"></i> Total : <span class="text-primary">{{ $total }} F</span>
    </span>
